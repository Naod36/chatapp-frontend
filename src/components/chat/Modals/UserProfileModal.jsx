      ...
      >
        ...
        >
          {viewingParticipantProfile.avatar_url ? (
            <img
              src={getAssetUrl(viewingParticipantProfile.avatar_url)}
              alt=""
              style={{ width: "100%", height: "100%", objectFit: "cover" }}
            />
          ) : (
            (viewingParticipantProfile.display_name ||
              viewingParticipantProfile.username)?.[0]?.toUpperCase() || "@"
          )}
          <div
            style={{
              position: "absolute",
        ...
        >
          ...
          <div
            style={{
              ...
              color: t.text,
              lineHeight: 1.45,
              fontStyle: viewingParticipantProfile.bio ? "normal" : "italic",
              opacity: viewingParticipantProfile.bio ? 1 : 0.6,
            }}
          >
