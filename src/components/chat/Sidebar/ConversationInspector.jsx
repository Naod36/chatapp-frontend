      ...
      {activeConv && (
        <div className="ht-inspector-inner">
          <div className="ht-inspector-avatar-box">
            <button
              className="ht-inspector-close-btn"
            ...
            >
              {activeConv.avatar_url ? (
                <img
                  src={getAssetUrl(activeConv.avatar_url)}
                  alt=""
              ...
              <div
                style={{
                  position: "absolute",
                  inset: 0,
                  background: `linear-gradient(to bottom, transparent 38%, ${t.inspectorBg} 100%)`,
                  pointerEvents: "none",
                }}
              />
            </div>
          ...
          <div
            className="ht-inspector-actions"
            style={{ borderBottom: t.border, paddingBottom: 20 }}
          >
            <button
            ...
            >
              ...
              >
                {(activeConv.participants || []).map((p) => {
                  ...
                  const isAdmin =
                    isCreator ||
                    (groupAdminsMap[activeConv.id] || []).includes(pId);
                ...
                {sharedFiles.map((fileMsg) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ cursor: "pointer" }}
                      onClick={() =>
                        window.open(getAssetUrl(fileMsg.media_url), "_blank")
                      }
                    >
                      <svg
                        width="24"
