...
export default function ConversationList({
  ...
  const checkIsTyping = (convId) => {
    ...
    return Object.entries(convTypists).some(
      ([uid, typing]) =>
        String(uid) !== String(user?.userId) && Boolean(typing),
    );
  };
  return (
    <div
      ...
      {activeRailTab === "chats" && (
        <>
          <div className="ht-sidebar-header">
            <div
              className="ht-sidebar-title-row"
              style={{
                display: "flex",
                alignItems: "center",
            ...
            {!searchQuery.trim() &&
              (() => {
                ...
                return (
                  <div
                    style={{ padding: "8px 16px 4px", borderBottom: t.border }}
                  >
                    <div
                      className="ht-section-label"
                      style={{
                        color: theme === "dark" ? "#38bdf8" : "#082a3bff",
                        paddingLeft: 0,
                        marginBottom: 6,
                        display: "flex",
                        alignItems: "center",
                    ...
                    {pinnedList.map((c) => {
                      ...
                      const isOnline =
                        !isGroup &&
                        !isSaved &&
                        c.other_participant?.status === "online";
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            marginBottom: 4,
                            border: isActive
                              ? `1px solid ${theme === "dark" ? "#38bdf8" : "#0284c7"}`
                            ...
                            >
                              ...
                              <span
                                style={{
                                  fontSize: 9.5,
                                  color:
                                    c.unread_count > 0 ? t.accent : t.textMuted,
                                  fontWeight:
                                    c.unread_count > 0 ? "700" : "normal",
                                  flexShrink: 0,
                                  marginLeft: 4,
                                }}
                              >
                        ...
                        >
                          ...
                          <span
                            style={{
                              ...
                              color:
                                c.unread_count > 0 ? t.accent : t.textMuted,
                              fontWeight: c.unread_count > 0 ? "700" : "normal",
                              flexShrink: 0,
                              marginLeft: 4,
                            }}
                          >
        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  {myProfile.avatar_url ? (
                    <img
                      src={getAssetUrl(myProfile.avatar_url)}
                      alt="Avatar"
                      style={{
                        width: "100%",
                        height: "100%",
            ...
            <div className="ht-form-group">
              <label className="ht-form-label" style={{ color: t.textMuted }}>
                Display Name
              </label>
              <input
                type="text"
            ...
            <div className="ht-form-group">
              ...
              <textarea
                value={myProfile.bio || ""}
                onChange={(e) =>
                  setMyProfile((prev) => ({ ...prev, bio: e.target.value }))
                }
            ...
            <div className="ht-form-group">
              ...
              <div
                onClick={() =>
                  setMyProfile((prev) => ({
                    ...prev,
                    is_public: prev.is_public !== false ? false : true,
                  }))
                }
                style={{
                  display: "flex",
        ...
        >
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ fontSize: 12, color: t.textMuted, marginTop: 3 }}>
              Manage your client preferences & options
            </div>
          </div>
                  ...
                  <div
                    style={{
                      ...
                      border:
                        theme === "light"
                          ? `2px solid ${t.accent}`
                          : "2px solid rgba(140,140,140,0.4)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      flexShrink: 0,
                ...
                >
                  <div>
                    <div
                      style={{ fontSize: 13.5, fontWeight: 700, color: t.text }}
                    >
                      Sound Chimes Enabled
                    </div>
                    <div
                      style={{ fontSize: 11, color: t.textMuted, marginTop: 2 }}
                    >
                      Play audio chime on incoming messages
                    </div>
                  </div>
                  <div
                    style={{
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11, color: t.textMuted, marginTop: 2 }}
                    >
                      Suppress all message audio playback
                    </div>
                  </div>
                  <div
                    style={{
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11, color: t.textMuted, marginTop: 2 }}
                    >
                      Inform senders when their messages have been read
                    </div>
                  </div>
                  <div
                    style={{
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11, color: t.textMuted, marginTop: 2 }}
                    >
                      Maximum allowed media attachment payload
                    </div>
                  </div>
                  <div
                    style={{
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 11.5, color: t.textMuted }}>
                  Get the native FlowChat experience
                </div>
              </div>
            </div>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              >
                    ...
                    setLatestRelease((prev) =>
                      prev
                        ? {
                            ...prev,
                            download_count:
                              (Number(prev.download_count) || 0) + 1,
                          }
                        : prev,
                    );
                    setTimeout(() => {
                ...
                >
                  ...
                  >
                    Point your mobile camera at the QR code to instantly start
                    download
                  </div>
                </div>
              </div>
              ...
              >
                💡 <strong>Installation Note:</strong> After downloading the{" "}
                <code>.apk</code> file on your Android device, tap it to
                install. If prompted, enable "Allow installation from unknown
                sources".
              </div>
            </div>
          ) : (
