...
import {
  UPLOAD_REJECTED_ERROR,
  validateUploadSize,
} from "../utils/uploadLimits.js";

export const API_BASE =
  import.meta.env.VITE_API_URL || "https://chatapp-backend-chyk.onrender.com";
export const WS_BASE =
  import.meta.env.VITE_WS_URL || "wss://chatapp-backend-chyk.onrender.com";
...
export async function apiFetch(endpoint, options = {}) {
  ...
  try {
    ...
    if (
      ...
      throw new Error(
        "Unable to connect to the FlowChat server. Please check your internet connection or try again later.",
      );
    }
    throw err;
  }
